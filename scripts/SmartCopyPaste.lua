...
local device = linux --nil is for automatic device detection, or manually change to: 'windows' or 'mac' or 'linux'
...
--	mp.add_key_binding('ctrl+alt+V', 'pasteCaps', paste)
...
--	mp.add_key_binding('ctrl+V', 'paste-playlistCaps', paste_playlist)
end
